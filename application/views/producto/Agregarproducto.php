...
<div class="container">
	<div class="well col-lg-8">
		<div class="a">
		<br><br><h2>Cargar nuevo producto</h2>
			...
			<div class="well bs-component form-horizontal">
				...
				<fieldset>
					<div class="form-group">
						<label class="col-lg-2 control-label" style="color: white">Descripción</label>
						<div class="col-lg-10">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label" style="color: white">Categoría</label>
						<div class="col-lg-10">
							<?php echo form_input(['name' => 'categoria_id', 
													'id' => 'categoria_id', 
													'class' => 'form-control',
													'placeholder' => '1-Accion - 2-Suspenso 3-Terror 4-Variados', 
													'value'=>set_value('categoria_id')]); ?>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label" style="color: white">Precio Costo</label>
						<div class="col-lg-10">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label" style="color: white">Precio Venta</label>
						<div class="col-lg-10">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label" style="color: white">Stock</label>
						<div class="col-lg-10">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label" style="color: white">Stock Minimo</label>
						<div class="col-lg-10">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label" style="color: white">Imagen</label>
						<div class="col-lg-10">
